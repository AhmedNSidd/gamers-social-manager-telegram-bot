...
def notify(update, context):
    ...
    if not user_id in notify_group["members"]:
        ...
        curr_user_mention = get_one_mention(
            context.bot, user_id, chat_id
        )
