...
def register_conversation_commands(dispatcher):
    ...
    conversation_handlers.append(ConversationHandler(
        entry_points=[
            CommandHandler("add_status_user", handlers.status.add_status_user.start),
            CallbackQueryHandler(handlers.status.add_status_user.start,
        ...
        fallbacks=[
            CallbackQueryHandler(handlers.status.add_status_user.cancel, "^cancel$"),
    ...
    conversation_handlers.append(ConversationHandler(
        entry_points=[
            ...
            CallbackQueryHandler(handlers.status.modify_status_user.start,
        ...
        states={
            handlers.status.modify_status_user.MAIN_MENU: [
                CallbackQueryHandler(handlers.status.modify_status_user.start,
                                     pattern="^modify_status_user$"),
                CallbackQueryHandler(handlers.status.modify_status_user.edit_or_delete,
                                     pattern="^[0-9a-f]{24}$"),
                CallbackQueryHandler(handlers.status.modify_status_user.edit,
                                     pattern="^edit_[0-9a-f]{24}$"),
                CallbackQueryHandler(handlers.status.modify_status_user.delete,
            ...
            handlers.status.modify_status_user.DELETING_EMPTY_STATUS_USER: [
                CallbackQueryHandler(handlers.status.modify_status_user.cancel,
                                     pattern="^cancel$"),
                CallbackQueryHandler(handlers.status.modify_status_user.confirm_delete,
    ...
    conversation_handlers.append(ConversationHandler(
        entry_points=[
            CommandHandler("add_notify_group", handlers.notify_groups.creation_and_modification.start)
        ],
        states={
            handlers.notify_groups.creation_and_modification.TYPING_NAME: [
                MessageHandler(Filters.text & (~Filters.command),
                               handlers.notify_groups.creation_and_modification.process_name),
            ],
            handlers.notify_groups.creation_and_modification.TYPING_DESCRIPTION: [
                MessageHandler(Filters.text & (~Filters.command),
                               handlers.notify_groups.creation_and_modification.process_description),
                CallbackQueryHandler(
                    handlers.notify_groups.creation_and_modification.process_description,
